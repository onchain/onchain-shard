...
module OnChain
  module API
    class Ethereum
      ...
      def self.create(to : String, from : String, amount : UInt64, gas_price : UInt64, gas_limit : UInt64) : EthereumToSign
      ...
      def self.sign_and_send(to : String, from : String, amount : UInt64, r : String, s : String, v : String, gas_price : UInt64, gas_limit : UInt64) : SendStatus
